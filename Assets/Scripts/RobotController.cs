...
public class RobotController : MonoBehaviour {
    ...
    void Update () {
        ...
        _animator.SetFloat("Velocity", Mathf.Abs(_vx));
    ...
    void OnCollisionEnter2D(Collision2D other)
    {
        ...
        else if (other.gameObject.tag == "Harmful")
            HarmPlayer(new Vector2(transform.position.x-other.contacts[0].point.x,0).normalized, 10);
    }
    ...
    void DoJump()
    {
        ...
        //_rigidbody.AddForce(new Vector2(-8000, 0));
        // play the jump sound
        PlaySound(jumpSFX);
    }
    ...
    void HarmPlayer (Vector2 direction, int damage)
    {
        _animator.SetTrigger("Harmed");
        _rigidbody.AddForce(direction * 5000f);
        PlaySound(harmedSFX);
        playerHealth -= damage;
        ...
        GameManager.gameManager.UpdateHealth(playerHealth);
    ...
    void PlayerDies ()
    {
        ...
        transform.Rotate(transform.forward, 90 * Mathf.Sign(transform.localScale.x));
        Invoke("FreezeMotion", 0.5f);
    }
